 ...
 * nnz, int nnx)*/
SYCL_EXTERNAL void
cuda_fdoperator420(double *vx, double *der2, int nnz, int nnx,
                   sycl::nd_item<3> item_ct1,
                   dpct::accessor<double, dpct::local, 2> s_vx)
{
    int i1, i2, id;
 ...
 * nnz, int nnx)*/
SYCL_EXTERNAL void
cuda_fdoperator410(double *vz, double *der1, int nnz, int nnx,
                   sycl::nd_item<3> item_ct1,
                   dpct::accessor<double, dpct::local, 2> s_vz)
{
    int i1, i2, id;
/* DPCT_ORIG     i1 = threadIdx.x + blockIdx.x*blockDim.x;*/
    i1 = item_ct1.get_local_id(2) +
...
/* DPCT_ORIG     if(threadIdx.x < 2)*/
    ...
    {
/* DPCT_ORIG         if(blockIdx.x) s_vz[threadIdx.x][threadIdx.y] =
 * vz[id-2];*/
 ...
 * nnz, int nnx)*/
SYCL_EXTERNAL void
cuda_fdoperator421(double *p, double *der2, int nnz, int nnx,
                   sycl::nd_item<3> item_ct1,
                   dpct::accessor<double, dpct::local, 2> s_p)
{
    int i1, i2, id;
/* DPCT_ORIG     i1 = threadIdx.x + blockIdx.x*blockDim.x;*/
    i1 = item_ct1.get_local_id(2) +
...
/* DPCT_ORIG     if(threadIdx.y < 1)*/
    ...
    {
/* DPCT_ORIG         if(blockIdx.y) s_p[threadIdx.x][threadIdx.y] =
 * p[id-nnz];*/
        if (item_ct1.get_group(1))
 ...
 * nnz, int nnx)*/
SYCL_EXTERNAL void
cuda_fdoperator411(double *p, double *der1, int nnz, int nnx,
                   sycl::nd_item<3> item_ct1,
                   dpct::accessor<double, dpct::local, 2> s_p)
{
    int i1, i2, id;
